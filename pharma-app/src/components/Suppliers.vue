      ...
      <main class="main-content">
        ...
        <section class="summary-grid">
          <div class="summary-item">
            <p class="summary-label">Total Suppliers (PBF)</p>
            <p class="summary-value">24 Distributor</p>
            <span class="summary-note green">Kemitraan aktif saat ini</span>
          </div>

          <div class="summary-item">
            <p class="summary-label">Rata-rata Waktu Pengiriman</p>
            <p class="summary-value">2.3 Hari</p>
            <span class="summary-note blue">Dari seluruh pesanan masuk</span>
          </div>

          <div class="summary-item">
            <p class="summary-label">Supplier Teratas Bulan Ini</p>
            <p class="summary-value">PT Kimia Farma</p>
            <span class="summary-note green">38% dari total volume pesanan</span>
          </div>
        </section>
...
const emit = defineEmits(['navigate', 'view-supplier', 'logout'])
