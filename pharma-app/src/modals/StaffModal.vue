      ...
      <form @submit.prevent="handleSubmit">
        <div class="field-grid">
          <div class="field wide">
            ...
            <input v-model="form.name" type="text" placeholder="cth: Siti Rahma" required />
          </div>
          <div class="field wide">
            <label>Email</label>
...
const emit = defineEmits(['close', 'save', 'remove-access'])
...
function handleSubmit() {
  emit('save', { id: props.member?.id, ...form.value })
}
</script>
